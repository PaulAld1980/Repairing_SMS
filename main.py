...
# server = SMSServer(token)
# print(token)
# Установленный факт: aGVsbG8gY3J5cHRvIGVudHVzaWFzdCA7KQ==
# Вывод: Гипотеза подтвердилась.
...
# Установленный факт:
# Первоначальное значение переменной token = 85b98d96709fd49a69ba8165676e4592
# Итоговое значение переменной token = aGVsbG8gY3J5cHRvIGVudHVzaWFzdCA7KQ==
...
# ст. Кострома
# ледяной дождь
# Вывод: Гипотеза не подтвердилась. Все 4 переменные несут корректные значения.
...
# Установленный факт: 
# Рассылаю сообщение:
#  Курск: ночью 15 октября ст. Томари ожидается ветер порывами до 13 м/с. Будьте внимательны и осторожны.
